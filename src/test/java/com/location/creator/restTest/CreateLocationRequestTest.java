...
public class CreateLocationRequestTest {
    ...
    void of_createsBodyForNonTray() {
        ...
        assertThat(body.path("data").path("attributes").path("barcode").isMissingNode()).isTrue();
    }
    ...
    public void forRoom_createsBodyWithoutAncestorForRoot() {
        ...
        assertThat(attributes.path("fields").path(0).path("id").asString()).isEqualTo("242870a3-dc72-4c84-82e7-6ab8cfc854e7");
        assertThat(attributes.path("fields").path(0).path("content").path("value").asString()).isEqualTo("Default");
        assertThat(body.path("data").path("attributes").path("barcode").isMissingNode()).isTrue();
    ...
    public void forTray_createsBodyForTray() {
        // 8        4   4   4       12 <- UUID
        String typeId = "11111111-2222-3333-4444-555555555555";
        String ancestorId = "location:54c1299d-62e9-4520-8af7-6114b45faeb2:ivt";
        ...
        assertThat(attributes.path("fields").size()).isEqualTo(1);
        assertThat(attributes.path("ancestors").path(0).path("id").asString()).isEqualTo("54c1299d-62e9-4520-8af7-6114b45faeb2");
        assertThat(attributes.path("barcode").asString()).isEqualTo("TM001");
    }
